...
// LOGIN SCREEN
// ---------------------------------------------------------------------------
function LoginScreen({ employees, settings, onLogin, loading, connectionStatus, loadErrors = [], onOpenSettings }) {
      ...
      <div className="flex-1 flex flex-col justify-center px-5 py-10 max-w-md mx-auto w-full">
        <div className="mb-8 text-center">
          <div className="inline-flex items-center gap-2 text-orange-500 mb-2">
            ...
            <span className="text-2xl font-extrabold uppercase text-white">{settings.companyName}</span>
          </div>
          <p className="text-stone-500 text-sm mt-1">Work Log</p>
        </div>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-5 pb-28 space-y-5">
      <div className="grid grid-cols-2 gap-3">
        ...
        <Card className="p-4">
          <p className="text-xs font-bold uppercase text-stone-500">This Week</p>
